...
//        }
    ...
    public static void rangoDePrecios(ArrayList<Oferta> listaOfertaComun, ArrayList<Oferta> listaOfertaPermanente){
        ...
        valor1 = oferta.getValor();
        valor2 = oferta.getValor();//Esta tres revisar si no son double
        valor3 = oferta.getValor();
    ...
    public static Oferta encontrarArticulos(long unCodigoDeBarras, ArrayList<Oferta> todasLasOfertas){
